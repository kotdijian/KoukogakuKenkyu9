...
---
###### 18
* セッション内の**記憶**: 連続するセッションのやりとりは受け継がれるが、一定以上の入力により揮発する
* セッション間の**記憶**, 情報の受け渡しは行われないとされるが、長期記憶(Memory)機能を持つものもある
* **パーソナライズ**: ChatGPTなどはユーザーの入力・応答から嗜好を推測し自動適用する
* **AIバイアス**: セッション内・間の**記憶**や**パーソナライズ**が生成される回答に影響を与えることがある
